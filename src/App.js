...
//  合约地址
const MYNFT_ADDRESS = "0xDEbC05F0751Ff6fA40D07f0368498C456FcA1157";
const MARKET_ADDRESS = "0xd3f08B2b896fe0a5A6e45BFac16F8eAb74894d05";
    ...
    <div className="App">
      ...
      {!account ? (
        ...
        <div className='body'>
          ...
          <h2 className='white_text'>正在出售的NFT</h2>
          {nftsForSale.length === 0 ? (
            <p className='white_text'>无NFT出售中</p>
          ) : (
            <ul>
